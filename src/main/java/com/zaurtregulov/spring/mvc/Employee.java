...
public class Employee {
    @Size (min = 2, message = "minim 2 symbols")
    private String name;
 ...
 //   @CheckEmail
    ...
    public Employee() {
        ...
        departments.put("Informazion tehnologi", "IT");
        departments.put("Human resources","HR");
        departments.put("Sales","Sales");
        carBrands =new HashMap<>();
        carBrands.put("BMW","BMW");
        carBrands.put("AUDI", "Audi");
        carBrands.put("Mersedes", "Mersees");
        languagesList = new HashMap<>();
        languagesList.put("EN", "EN");
        languagesList.put("DU", "DU");
        languagesList.put("FU", "FU");
